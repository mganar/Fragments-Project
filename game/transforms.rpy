# transforms.rpy 
transform tcommon(x=960, z=0.70):
...
# Static versions for non-animated idle swaps
transform t11_static:
    xcenter 640
    ypos 1.03
    zoom 0.5
    alpha 1.0

transform t21_static:
    xcenter 440
    ypos 1.03
    zoom 0.5
    alpha 1.0

transform t22_static:
    xcenter 880
    ypos 1.03
    zoom 0.5
    alpha 1.0

transform t31_static:
    xcenter 300
    ypos 1.03
    zoom 0.5
    alpha 1.0

transform t33_static:
    xcenter 980
    ypos 1.03
    zoom 0.5
    alpha 1.0
...
transform t44:
    tcommon(1080)
transform t31:
    tcommon(300)   # Far left
transform t21:
    tcommon(640)   # Left center
transform t11:
    tcommon(960)   # Center
transform t22:
    tcommon(1280)  # Right center
transform t33:
    tcommon(1650)  # Far right
